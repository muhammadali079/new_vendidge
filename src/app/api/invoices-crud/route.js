...
export async function POST(req) {
  ...
  try {
    ...
    // 3. Safely calculate and LOCK the next invoice number for this user
    ...
    // 6. Commit the transaction to make the new invoice and number permanent
...
export async function DELETE(req) {
  ...
  try {
    ...
    // 4. Rearrange remaining invoice numbers in Parent Table
    await connection.query(
